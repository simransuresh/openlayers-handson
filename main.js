...
// import { WebGLPoints as WebGLPointsLayer } from 'ol/layer'; --> does not render so changing it to
...
const map = new Map({
  ...
  layers: [
    ...
    // new WebGLPointsLayer({  // replacing normal vector layer of canvas 2d rendering to webgl rendering
    //   source: source,
    //   style: {
    //     symbol: {
    //       symbolType: 'circle',
